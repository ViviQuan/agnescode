...
import { SessionMessageTable } from "@agnes-ai/core/session/sql"
...
import { Shell } from "@agnes-ai/core/shell"
...
import { LocationServiceMap, locationServiceMapLayer } from "@agnes-ai/core/location-services"
...
const writeConfig = Effect.fn("test.writeConfig")(function* (dir: string, config: Partial<ConfigV1.Info>) {
  yield* writeText(
    ...
    JSON.stringify({ $schema: "https://agnescode.ai/config.json", ...config }),
  )
})
