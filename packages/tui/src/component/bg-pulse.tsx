...
class GoUpsellArtRenderable extends FrameBufferRenderable {
  ...
  constructor(ctx: RenderContext, options: GoUpsellArtOptions = {}) {
    ...
    this._noLogo = options.noLogo === true
  }
...
export function BgPulse(props: { noLogo?: boolean }) {
