...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@agnes-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.agnescode || flags.exa || flags.parallel
}
