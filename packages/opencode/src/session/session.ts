...
import { PermissionV1 } from "@agnes-ai/core/v1/permission"
import { Slug } from "@agnes-ai/core/util/slug"
import { SessionV1 } from "@agnes-ai/core/v1/session"
import { serviceUse } from "@agnes-ai/core/effect/service-use"
import path from "path"
import { BackgroundJob } from "@/background/job"
import { Decimal } from "decimal.js"
import type { ProviderMetadata, Usage } from "@agnes-ai/llm"
...
import { PartTable, SessionTable } from "@agnes-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@agnes-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".agnescode", "plans")
