...
import { EventSequenceTable, EventTable } from "@agnes-ai/core/event/sql"
...
import { WorkspaceEvent } from "@agnes-ai/schema/workspace-event"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AGNESCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AGNESCODE_WORKSPACE_ID: config.id,
        AGNESCODE_EXPERIMENTAL_WORKSPACES: "true",
