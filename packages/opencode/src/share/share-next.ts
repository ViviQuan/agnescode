...
import type * as SDK from "@agnes-ai/sdk/v2"
...
import { SessionShareTable } from "@agnes-ai/core/share/sql"
...
const disabled = process.env["AGNESCODE_DISABLE_SHARE"] === "true" || process.env["AGNESCODE_DISABLE_SHARE"] === "1"
