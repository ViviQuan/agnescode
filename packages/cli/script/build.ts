...
for (const item of targets) {
  ...
  const result = await Bun.build({
    ...
    define: {
      ...
      AGNESCODE_CLI_NAME: `'${binary}'`,
      AGNESCODE_MODELS_DEV: modelsData,
      AGNESCODE_CHANNEL: `'${Script.channel}'`,
      AGNESCODE_LIBC: item.os === "linux" ? `'${item.abi ?? "glibc"}'` : "undefined",
    ...
    JSON.stringify(
      {
        ...
        license: "MIT",
        repository: { type: "git", url: "https://github.com/ViviQuan/agnescode" },
        os: [item.os],
        cpu: [item.arch],
      },
      null,
