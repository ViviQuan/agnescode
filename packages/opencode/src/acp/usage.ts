...
import type { AssistantMessage as AgnesCodeAssistantMessage, Message } from "@agnes-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@agnes-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<AgnesCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<AgnesCodeAssistantMessage, "role"> &
  Partial<Pick<AgnesCodeAssistantMessage, "providerID" | "modelID">>
