...
import { Hash } from "@agnes-ai/core/util/hash"
...
import { optional } from "@agnes-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@agnes-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
  ...
  return {
    ...
    "amazon-bedrock": Effect.fnUntraced(function* () {
      ...
      return {
        ...
        async getModel(sdk: any, modelID: string, options?: Record<string, any>, model?: Model) {
          ...
          // 1. options.region from agnescode.json provider config
    ...
    llmgateway: () =>
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://agnescode.ai/",
            "X-Title": "agnescode",
            "X-Source": "agnescode",
          },
        },
      ...
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://agnescode.ai/",
            "X-Title": "agnescode",
            "X-BILLING-INVOKE-ORIGIN": "AgnesCode",
          },
        },
      }),
    vercel: () =>
    ...
    "cloudflare-ai-gateway": Effect.fnUntraced(function* (input: Info) {
      ...
      if (!apiToken) {
        throw new Error(
          "CLOUDFLARE_API_TOKEN (or CF_AIG_TOKEN) is required for Cloudflare AI Gateway. " +
            "Set it via environment variable or run `agnescode auth cloudflare-ai-gateway`.",
        )
      }
      ...
      const opts = {
        ...
        headers: {
          "User-Agent": `agnescode/${InstallationVersion} cloudflare-ai-gateway (${os.platform()} ${os.release()}; ${os.arch()})`,
        },
      }
    ...
    cerebras: () =>
      Effect.succeed({
        ...
        options: {
          headers: {
            "X-Cerebras-3rd-Party-Integration": "agnescode",
          },
        },
      }),
    kilo: () =>
    ...
    "snowflake-cortex": Effect.fnUntraced(function* (input: Info) {
      ...
      if (!account || !token) {
        ...
        return {
          ...
          async getModel() {
            throw new Error(
              `Snowflake Cortex: missing credentials (${missing}). Provide a bearer token (OAuth, JWT, or PAT) via env var, agnescode auth, or provider options.`,
            )
          },
        }
      }
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(() =>
      Effect.gen(function* () {
        ...
        if (!providers[ProviderV2.ID.make("agnes")]) {
          providers[ProviderV2.ID.make("agnes")] = {
            ...
            models: {
              "agnes-3.0-flash": {
                id: ModelV2.ID.make("agnes-3.0-flash"),
                providerID: ProviderV2.ID.make("agnes"),
                name: "Agnes 3.0 Flash",
                api: { id: "agnes-3.0-flash", url: "https://apihub.agnes-ai.com/v1", npm: "@ai-sdk/openai-compatible" },
                capabilities: {
                  temperature: true,
                  reasoning: true,
                  attachment: true,
              ...
              "agnes-2.5-pro": {
                id: ModelV2.ID.make("agnes-2.5-pro"),
                providerID: ProviderV2.ID.make("agnes"),
                name: "Agnes 2.5 Pro",
                api: { id: "agnes-2.5-pro", url: "https://apihub.agnes-ai.com/v1", npm: "@ai-sdk/openai-compatible" },
                capabilities: {
                  temperature: true,
                  reasoning: true,
                  attachment: true,
                ...
                cost: { input: 0.45, output: 0.9, cache: { read: 0.045, write: 0 } },
              ...
              "agnes-2.5-pro-beta": {
                id: ModelV2.ID.make("agnes-2.5-pro-beta"),
                providerID: ProviderV2.ID.make("agnes"),
                ...
                cost: { input: 0.1, output: 0.3, cache: { read: 0.01, write: 0 } },
                limit: { context: 1048576, output: 65536 },
                status: "beta",
                options: {},
                headers: {},
              ...
              "agnes-2.5-flash": {
                id: ModelV2.ID.make("agnes-2.5-flash"),
                providerID: ProviderV2.ID.make("agnes"),
                name: "Agnes 2.5 Flash",
                api: { id: "agnes-2.5-flash", url: "https://apihub.agnes-ai.com/v1", npm: "@ai-sdk/openai-compatible" },
                capabilities: {
                  temperature: true,
                  reasoning: true,
                  attachment: true,
