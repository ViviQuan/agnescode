...
import { normalizePromptContent } from "@agnes-ai/tui/editor"
...
import { AGNESCODE_BASE_MODE, useBindings } from "@agnes-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close AgnesCode" } satisfies SlashOption,
    ]
