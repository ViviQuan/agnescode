...
import { AgentV2 } from "@agnes-ai/core/agent"
import { ModelV2 } from "@agnes-ai/core/model"
import { SessionV2 } from "@agnes-ai/core/session"
import { Agent } from "@agnes-ai/schema/agent"
import { Location } from "@agnes-ai/schema/location"
import { Model } from "@agnes-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@agnes-ai/schema/prompt"
import { Provider } from "@agnes-ai/schema/provider"
import { Project } from "@agnes-ai/schema/project"
import { ProjectDirectories } from "@agnes-ai/schema/project-directories"
import { PermissionV1 } from "@agnes-ai/schema/permission-v1"
import { Session } from "@agnes-ai/schema/session"
import { SessionInput } from "@agnes-ai/schema/session-input"
import { SessionMessage } from "@agnes-ai/schema/session-message"
import { Workspace } from "@agnes-ai/schema/workspace"
import { Command } from "@agnes-ai/schema/command"
import { Connection } from "@agnes-ai/schema/connection"
import { Credential } from "@agnes-ai/schema/credential"
import { FileSystem } from "@agnes-ai/schema/filesystem"
import { Integration } from "@agnes-ai/schema/integration"
import { LLM } from "@agnes-ai/schema/llm"
import { Permission } from "@agnes-ai/schema/permission"
import { Plugin } from "@agnes-ai/schema/plugin"
import { Pty } from "@agnes-ai/schema/pty"
import { Reference } from "@agnes-ai/schema/reference"
import { SessionTodo } from "@agnes-ai/schema/session-todo"
import { Skill } from "@agnes-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@agnes-ai/schema/schema"
import { ProviderV2 } from "@agnes-ai/core/provider"
import { PluginV2 } from "@agnes-ai/core/plugin"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@agnes-ai/core/command"),
    import("@agnes-ai/core/integration/connection"),
    import("@agnes-ai/core/credential"),
    import("@agnes-ai/core/filesystem"),
    import("@agnes-ai/core/integration"),
    import("@agnes-ai/core/location"),
    import("@agnes-ai/llm"),
    import("@agnes-ai/core/permission"),
    import("@agnes-ai/core/v1/permission"),
    import("@agnes-ai/core/project/copy"),
    import("@agnes-ai/core/pty"),
    import("@agnes-ai/core/project/schema"),
    import("@agnes-ai/core/reference"),
    import("@agnes-ai/core/session/input"),
    import("@agnes-ai/core/session/message"),
    import("@agnes-ai/core/session/todo"),
    import("@agnes-ai/core/session/prompt"),
    import("@agnes-ai/core/skill"),
    import("@agnes-ai/core/v2-schema"),
    import("@agnes-ai/core/schema"),
    import("@agnes-ai/core/workspace"),
  ])
