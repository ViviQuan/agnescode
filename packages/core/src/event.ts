...
import type { Data, Definition, Payload } from "@agnes-ai/schema/event"
...
import { Durable } from "@agnes-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@agnes-ai/schema/event").ID
export type { Data, Definition, Payload } from "@agnes-ai/schema/event"
