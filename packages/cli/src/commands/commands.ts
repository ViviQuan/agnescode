...
declare const AGNESCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AGNESCODE_CLI_NAME === "string" ? AGNESCODE_CLI_NAME : "agnescode", {
  description: "AgnesCode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
