...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      AGNESCODE_EXPERIMENTAL_WORKSPACES: Flag.AGNESCODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.AGNESCODE_EXPERIMENTAL_WORKSPACES = original.AGNESCODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
