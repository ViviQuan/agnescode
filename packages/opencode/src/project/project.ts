...
import { ProjectDirectoryTable, ProjectTable } from "@agnes-ai/core/project/sql"
import { ProjectDirectories } from "@agnes-ai/core/project/directories"
...
import { which } from "@agnes-ai/core/util/which"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.AGNESCODE_FAKE_VCS)
