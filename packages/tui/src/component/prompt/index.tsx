...
import type { AssistantMessage, FilePart, UserMessage } from "@agnes-ai/sdk/v2"
...
import { AGNESCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpencodeKeymap } from "../../keymap"
...
export function Prompt(props: PromptProps) {
  ...
  function promptModelWarning() {
    ...
    if (
      ...
      !sync.data.provider.some((p) => Object.values(p.models).some((m) => m.cost?.input !== 0))
    ) {
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.AGNESCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
