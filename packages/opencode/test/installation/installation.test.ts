...
import { makeGlobalNode } from "@agnes-ai/core/effect/app-node"
...
import { InstallationChannel } from "@agnes-ai/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("anomalyco/tap/agnescode")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("agnescode")) return "agnescode"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("anomalyco/tap/agnescode") && args.includes("--formula")) return "agnescode"
