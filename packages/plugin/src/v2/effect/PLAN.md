...
- Effect plugins import `@agnes-ai/plugin/v2/effect`, not `@agnes-ai/core`.
- Public domain values use generated `@agnes-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@agnes-ai/plugin/v2/effect`.
