...
import defaultSoundPath from "@agnes-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@agnes-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@agnes-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@agnes-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@agnes-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@agnes-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "agnescode"
const DEFAULT_PACK_ID = "agnescode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "AgnesCode Default",
  builtin: true,
  sounds: {
