...
const originalWorkspaces = Flag.AGNESCODE_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.AGNESCODE_EXPERIMENTAL_WORKSPACES = originalWorkspaces
...
describe("session HttpApi", () => {
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        Flag.AGNESCODE_EXPERIMENTAL_WORKSPACES = true
