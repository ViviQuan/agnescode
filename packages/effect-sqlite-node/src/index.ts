...
export const TypeId: TypeId = "~@agnes-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@agnes-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@agnes-ai/effect-sqlite-node/NodeSqliteClient")
