...
> current private `@agnes-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@agnes-ai/ai`
...
import { LLM } from "@agnes-ai/ai"
import { OpenAI } from "@agnes-ai/ai/providers/openai"
...
```ts
import { Message } from "@agnes-ai/ai"
...
import { LLM, Tool } from "@agnes-ai/ai"
...
```ts
import { LLM } from "@agnes-ai/ai/promise"
import { OpenAI } from "@agnes-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@agnes-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@agnes-ai/ai/provider"
...
@agnes-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@agnes-ai/ai/providers/openai
@agnes-ai/ai/providers/anthropic
@agnes-ai/ai/providers/google
...
```
