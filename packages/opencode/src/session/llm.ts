...
import { llmClient } from "@agnes-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@agnes-ai/llm"
import { LLMClient } from "@agnes-ai/llm/route"
import type { LLMClientService } from "@agnes-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @agnes-ai/llm. It
