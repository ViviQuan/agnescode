import type { Hooks, PluginInput } from "@agnes-ai/plugin"
import type { Model } from "@agnes-ai/sdk/v2"
import { InstallationVersion } from "@agnes-ai/core/installation/version"
import { OauthCallbackPage } from "@agnes-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. AgnesCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
