...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AGNESCODE_CALLER", () => {
    process.env["AGNESCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AGNESCODE_CALLER", () => {
    process.env["AGNESCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AGNESCODE_CALLER", () => {
    process.env["AGNESCODE_CALLER"] = "unknown"
