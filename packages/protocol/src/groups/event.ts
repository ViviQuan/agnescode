import { Event } from "@agnes-ai/schema/event"
import { EventManifest } from "@agnes-ai/schema/event-manifest"
import { Location } from "@agnes-ai/schema/location"
import type { Definition } from "@agnes-ai/schema/event"
...
export const AgnesCodeEvent = event.schema
export type AgnesCodeEvent = typeof AgnesCodeEvent.Type
export type AgnesCodeEventEncoded = typeof AgnesCodeEvent.Encoded
