import type { JsonSchema, LLMRequest, ProviderMetadata } from "@agnes-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@agnes-ai/llm"
import { AmazonBedrock, Anthropic, Azure, Google, OpenAI, OpenAICompatible, OpenRouter } from "@agnes-ai/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @agnes-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
